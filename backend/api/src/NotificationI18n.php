...
final class NotificationI18n
{
    ...
    private const T = [
        ...
        'challenge_group_result_photo' => [
            'fr'      => ["🏆 {name} a choisi la photo gagnante", "Touche pour voir qui a gagné"],
            'vi'      => ["🏆 {name} đã chọn ảnh chiến thắng",     "Chạm để xem ai thắng"],
            'es'      => ["🏆 {name} eligió la foto ganadora",     "Toca para ver quién ganó"],
            'it'      => ["🏆 {name} ha scelto la foto vincente",  "Tocca per vedere chi ha vinto"],
            'pt-br'   => ["🏆 {name} escolheu a foto vencedora",   "Toque para ver quem ganhou"],
            'pt-pt'   => ["🏆 {name} escolheu a foto vencedora",   "Toca para ver quem ganhou"],
            'de'      => ["🏆 {name} hat das Siegerfoto gewählt",  "Tippe, um zu sehen, wer gewonnen hat"],
            'nl'      => ["🏆 {name} koos de winnende foto",       "Tik om te zien wie won"],
            'zh-hans' => ["🏆 {name} 选出了获胜照片",                "点击查看谁赢了"],
            'zh-hant' => ["🏆 {name} 選出了獲勝照片",                "點擊查看誰贏了"],
            'ja'      => ["🏆 {name} が優勝写真を選びました",         "タップして結果を見る"],
            'ko'      => ["🏆 {name} 님이 우승 사진을 골랐어요",      "탭해서 누가 이겼는지 확인하세요"],
            'fil'     => ["🏆 Pinili ni {name} ang panalong litrato", "I-tap para makita kung sino ang nanalo"],
            'th'      => ["🏆 {name} เลือกรูปที่ชนะแล้ว",            "แตะเพื่อดูว่าใครชนะ"],
            'id'      => ["🏆 {name} memilih foto pemenang",       "Ketuk untuk lihat siapa yang menang"],
            'hi'      => ["🏆 {name} ने जीतने वाली फ़ोटो चुनी",      "देखने के लिए टैप करें कि कौन जीता"],
            'ru'      => ["🏆 {name} выбрал победное фото",         "Нажми, чтобы узнать победителя"],
            'ar'      => ["🏆 {name} اختار الصورة الفائزة",          "اضغط لمعرفة الفائز"],
        ],
        'challenge_group_result_meet' => [
            'fr'      => ["🎉 {name} a validé le rendez-vous", "Touche pour voir comment ça s'est passé"],
            'vi'      => ["🎉 {name} đã xác nhận buổi gặp",    "Chạm để xem kết quả"],
            'es'      => ["🎉 {name} validó el encuentro",     "Toca para ver cómo fue"],
            'it'      => ["🎉 {name} ha validato l'incontro",  "Tocca per vedere com'è andata"],
            'pt-br'   => ["🎉 {name} validou o encontro",      "Toque para ver como foi"],
            'pt-pt'   => ["🎉 {name} validou o encontro",      "Toca para ver como correu"],
            'de'      => ["🎉 {name} hat das Treffen bestätigt", "Tippe, um zu sehen, wie es lief"],
            'nl'      => ["🎉 {name} bevestigde de meet",      "Tik om te zien hoe het ging"],
            'zh-hans' => ["🎉 {name} 确认了见面",               "点击查看结果"],
            'zh-hant' => ["🎉 {name} 確認了見面",               "點擊查看結果"],
            'ja'      => ["🎉 {name} がミートを確定しました",     "タップして結果を見る"],
            'ko'      => ["🎉 {name} 님이 모임을 확정했어요",    "탭해서 결과를 확인하세요"],
            'fil'     => ["🎉 Na-validate ni {name} ang meet", "I-tap para makita kung kumusta"],
            'th'      => ["🎉 {name} ยืนยันการนัดพบแล้ว",        "แตะเพื่อดูว่าเป็นยังไง"],
            'id'      => ["🎉 {name} memvalidasi pertemuan",   "Ketuk untuk lihat hasilnya"],
            'hi'      => ["🎉 {name} ने मीट वैलिडेट की",         "देखने के लिए टैप करें कि कैसा रहा"],
            'ru'      => ["🎉 {name} подтвердил встречу",       "Нажми, чтобы узнать, как прошло"],
            'ar'      => ["🎉 {name} وثّق اللقاء",               "اضغط لمعرفة كيف جرى"],
        ],
