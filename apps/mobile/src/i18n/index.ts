...
const resources = {
  en: { common: en_common, auth: en_auth, landing: en_landing, here: en_here, now: en_now, chat: en_chat, event: en_event, hangout: en_hangout, dm: en_dm, notifications: en_notifications, publicProfile: en_publicProfile, me: en_me, misc: en_misc, cities: en_cities, cityNames: en_cityNames, upcoming: en_upcoming, archive: en_archive },
  fr: { common: fr_common, auth: fr_auth, landing: fr_landing, here: fr_here, now: fr_now, chat: fr_chat, event: fr_event, hangout: fr_hangout, dm: fr_dm, notifications: fr_notifications, publicProfile: fr_publicProfile, me: fr_me, misc: fr_misc, cities: fr_cities, cityNames: fr_cityNames, upcoming: fr_upcoming, archive: fr_archive },
  vi: { common: vi_common, auth: vi_auth, landing: vi_landing, here: vi_here, now: vi_now, chat: vi_chat, event: vi_event, hangout: vi_hangout, dm: vi_dm, notifications: vi_notifications, publicProfile: vi_publicProfile, me: vi_me, misc: vi_misc, cities: vi_cities, cityNames: vi_cityNames, upcoming: vi_upcoming, archive: vi_archive },
  es: { common: es_common, auth: es_auth, landing: es_landing, here: es_here, now: es_now, chat: es_chat, event: es_event, hangout: es_hangout, dm: es_dm, notifications: es_notifications, publicProfile: es_publicProfile, me: es_me, misc: es_misc, cities: es_cities, cityNames: es_cityNames, upcoming: es_upcoming, archive: es_archive },
  it: { common: it_common, auth: it_auth, landing: it_landing, here: it_here, now: it_now, chat: it_chat, event: it_event, hangout: it_hangout, dm: it_dm, notifications: it_notifications, publicProfile: it_publicProfile, me: it_me, misc: it_misc, cities: it_cities, cityNames: it_cityNames, upcoming: it_upcoming, archive: it_archive },
  'pt-br': { common: ptbr_common, auth: ptbr_auth, landing: ptbr_landing, here: ptbr_here, now: ptbr_now, chat: ptbr_chat, event: ptbr_event, hangout: ptbr_hangout, dm: ptbr_dm, notifications: ptbr_notifications, publicProfile: ptbr_publicProfile, me: ptbr_me, misc: ptbr_misc, cities: ptbr_cities, cityNames: ptbr_cityNames, upcoming: ptbr_upcoming, archive: ptbr_archive },
  'pt-pt': { common: ptpt_common, auth: ptpt_auth, landing: ptpt_landing, here: ptpt_here, now: ptpt_now, chat: ptpt_chat, event: ptpt_event, hangout: ptpt_hangout, dm: ptpt_dm, notifications: ptpt_notifications, publicProfile: ptpt_publicProfile, me: ptpt_me, misc: ptpt_misc, cities: ptpt_cities, cityNames: ptpt_cityNames, upcoming: ptpt_upcoming, archive: ptpt_archive },
  de: { common: de_common, auth: de_auth, landing: de_landing, here: de_here, now: de_now, chat: de_chat, event: de_event, hangout: de_hangout, dm: de_dm, notifications: de_notifications, publicProfile: de_publicProfile, me: de_me, misc: de_misc, cities: de_cities, cityNames: de_cityNames, upcoming: de_upcoming, archive: de_archive },
  nl: { common: nl_common, auth: nl_auth, landing: nl_landing, here: nl_here, now: nl_now, chat: nl_chat, event: nl_event, hangout: nl_hangout, dm: nl_dm, notifications: nl_notifications, publicProfile: nl_publicProfile, me: nl_me, misc: nl_misc, cities: nl_cities, cityNames: nl_cityNames, upcoming: nl_upcoming, archive: nl_archive },
  ...
  ja: { common: ja_common, auth: ja_auth, landing: ja_landing, here: ja_here, now: ja_now, chat: ja_chat, event: ja_event, hangout: ja_hangout, dm: ja_dm, notifications: ja_notifications, publicProfile: ja_publicProfile, me: ja_me, misc: ja_misc, cities: ja_cities, cityNames: ja_cityNames, upcoming: ja_upcoming, archive: ja_archive },
  ko: { common: ko_common, auth: ko_auth, landing: ko_landing, here: ko_here, now: ko_now, chat: ko_chat, event: ko_event, hangout: ko_hangout, dm: ko_dm, notifications: ko_notifications, publicProfile: ko_publicProfile, me: ko_me, misc: ko_misc, cities: ko_cities, cityNames: ko_cityNames, upcoming: ko_upcoming, archive: ko_archive },
  fil: { common: fil_common, auth: fil_auth, landing: fil_landing, here: fil_here, now: fil_now, chat: fil_chat, event: fil_event, hangout: fil_hangout, dm: fil_dm, notifications: fil_notifications, publicProfile: fil_publicProfile, me: fil_me, misc: fil_misc, cities: fil_cities, cityNames: fil_cityNames, upcoming: fil_upcoming, archive: fil_archive },
  th: { common: th_common, auth: th_auth, landing: th_landing, here: th_here, now: th_now, chat: th_chat, event: th_event, hangout: th_hangout, dm: th_dm, notifications: th_notifications, publicProfile: th_publicProfile, me: th_me, misc: th_misc, cities: th_cities, cityNames: th_cityNames, upcoming: th_upcoming, archive: th_archive },
  id: { common: id_common, auth: id_auth, landing: id_landing, here: id_here, now: id_now, chat: id_chat, event: id_event, hangout: id_hangout, dm: id_dm, notifications: id_notifications, publicProfile: id_publicProfile, me: id_me, misc: id_misc, cities: id_cities, cityNames: id_cityNames, upcoming: id_upcoming, archive: id_archive },
  hi: { common: hi_common, auth: hi_auth, landing: hi_landing, here: hi_here, now: hi_now, chat: hi_chat, event: hi_event, hangout: hi_hangout, dm: hi_dm, notifications: hi_notifications, publicProfile: hi_publicProfile, me: hi_me, misc: hi_misc, cities: hi_cities, cityNames: hi_cityNames, upcoming: hi_upcoming, archive: hi_archive },
  ru: { common: ru_common, auth: ru_auth, landing: ru_landing, here: ru_here, now: ru_now, chat: ru_chat, event: ru_event, hangout: ru_hangout, dm: ru_dm, notifications: ru_notifications, publicProfile: ru_publicProfile, me: ru_me, misc: ru_misc, cities: ru_cities, cityNames: ru_cityNames, upcoming: ru_upcoming, archive: ru_archive },
  ar: { common: ar_common, auth: ar_auth, landing: ar_landing, here: ar_here, now: ar_now, chat: ar_chat, event: ar_event, hangout: ar_hangout, dm: ar_dm, notifications: ar_notifications, publicProfile: ar_publicProfile, me: ar_me, misc: ar_misc, cities: ar_cities, cityNames: ar_cityNames, upcoming: ar_upcoming, archive: ar_archive },
};
