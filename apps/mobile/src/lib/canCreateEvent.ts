...
export interface CanCreateEventInput {
  isLegend:   boolean;
  todayCount: number;
}

export function canCreateEventToday({ isLegend, todayCount }: CanCreateEventInput): boolean {
 ...
 */
export function isLegend(account: { badges?: string[] } | null | undefined): boolean {
