...
const styles = StyleSheet.create({
  ...
  navTitle: { flex: 1, textAlign: 'center', fontSize: FontSizes.lg, fontWeight: '800', color: Colors.text },
  empty: { textAlign: 'center', color: Colors.muted, marginTop: Spacing.xl, paddingHorizontal: Spacing.lg },
  scroll: { padding: Spacing.md, gap: Spacing.md, paddingBottom: Spacing.xl },
  intro: { fontSize: FontSizes.sm, color: Colors.muted, marginBottom: 2 },
  card: { backgroundColor: Colors.bg2, borderRadius: Radius.lg, borderWidth: 1, borderColor: Colors.border, padding: Spacing.md, gap: 6 },
  ...
  lineLabel: { flex: 1, fontSize: FontSizes.sm, color: Colors.text, fontWeight: '600' },
