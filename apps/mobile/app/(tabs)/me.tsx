...
const styles = StyleSheet.create({
  ...
  avatarText:   { fontSize: FontSizes.xxl, fontWeight: '700', color: Colors.accent },
  displayName:  { fontSize: FontSizes.xl, fontWeight: '700', color: Colors.text, letterSpacing: -0.3 },
  ...
  eventTitle: { fontSize: FontSizes.md, fontWeight: '600', color: Colors.text, flexShrink: 1 },
